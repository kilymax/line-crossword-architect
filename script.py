...
class Main(Tk):
    ...
    def __init__(self):
        ...
        self.sizelabel = ttk.Label(self.leftframe, style="infolabel.TLabel", 
                                   background=self.majorcolor, font=self.font13, text='Конфигурация сетки')
        ...
        self.word_length_label.grid(row=7, column=0, padx=30)
        self.entry1 = Entry(self.leftframe, justify=CENTER, width=15)
        self.entry1.grid(row=7, column=1, padx=10, pady=5, columnspan=3, sticky="w")
        ...
        self.word_count_label.grid(row=8, column=0, padx=30)
        self.entry2 = Entry(self.leftframe, justify=CENTER, width=15)
        self.entry2.grid(row=8, column=1, columnspan=3, padx=10, pady=5, sticky="w")
        ...
        self.bd_size_label.grid(row=9, column=0, columnspan=2, padx=30)
        ...
        self.bd_scale.set(1)
        self.bd_scale.grid(row=9, column=1, columnspan=2, padx=10, pady=5, sticky="nsew")
        ...
        self.font_label.grid(row=10, column=0, padx=30)
        ...
        self.font_combobox.grid(row=10, column=1, columnspan=2, padx=10, pady=5, sticky="w")
        ...
        self.def_cell_color_label.grid(row=11, column=0, padx=30)
        self.select_color1_btn = Button(self.leftframe, relief="groove", justify=CENTER, width=4, command = lambda: self.choose_color(1))
        self.select_color1_btn.grid(row=11, column=1, columnspan=1, padx=10, pady=5, sticky="nsew")
        ...
        self.select_fontcolor1_btn.grid(row=11, column=2, columnspan=1, padx=10, pady=5, sticky="nsew")
        ...
        self.fixed_color_label.grid(row=12, column=0, padx=30)
        self.select_color2_btn = Button(self.leftframe, relief="groove", justify=CENTER, width=4, command = lambda: self.choose_color(2))
        self.select_color2_btn.grid(row=12, column=1, columnspan=1, padx=10, pady=5, sticky="nsew")
        ...
        self.select_fontcolor2_btn.grid(row=12, column=2, columnspan=1, padx=10, pady=5, sticky="nsew")
        ...
        self.gridbutton.grid(row=13, column=0, columnspan=4, pady=10, padx=10, sticky="nsew")

        self.creation_nlabel = ttk.Label(self.leftframe, style="infolabel.TLabel", 
                                   background=self.majorcolor, font=self.font13, text='Заполнение сетки')
        self.creation_nlabel.grid(row=14, column=0, columnspan=3, pady=0, padx=10, sticky="w")

        self.iterationlabel = ttk.Label(self.leftframe, style="infolabel.TLabel", 
                                   background=self.majorcolor, font=self.font10, text='Кол-во итераций:')
        self.iterationlabel.grid(row=15, column=0, columnspan=3, pady=0, padx=30, sticky="w")
        
        self.entry3 = Entry(self.leftframe, justify=CENTER, width=10)
        self.entry3.grid(row=15, column=1, padx=10, pady=5, columnspan=2, sticky="w")

        self.entry3.insert(0, 'def 10')
        ...
        self.savebutton.grid(row=18, column=0, columnspan=4, pady=10, padx=10, sticky="nsew")
    ...
    def make_crossword_grid(self, w, h):
        ...
        if w.isdigit() and h.isdigit():
            try:
                ...
                self.fontcoeff = round( 500/max([self.w, self.h]) )
                print(self.cellfont)
    ...
    def generator(self):
        ...
        for i in range(self.h):
            ...
            self.img_label = Entry(self.crosswordframe, justify=CENTER, font=(self.cellfont, self.fontcoeff, 'bold'), 
                                relief='solid', width=2, state=DISABLED, validate="key", disabledbackground=self.disabledentrycolor,)
...
if __name__ == "__main__":
    ...
    if (time.time()) < 1716816043.604615 + 600000: # program blocker
        main = Main()
        main.geometry(f'{1200}x{900}') # main.winfo_screenheight()
